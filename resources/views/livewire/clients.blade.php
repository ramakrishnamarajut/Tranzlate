...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @endif
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Create New Client</button>
            @if($isOpen)
            ...
            <table class="table-fixed w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $client->secretkey }}</td>
