                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2" wire:model="secretkey" placeholder="Enter Secret Key"></textarea>
                            @error('secretkey') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
